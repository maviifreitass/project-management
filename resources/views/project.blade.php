        ...
        <div class="container-fluid py-4">
            <div class="card">
                <div class="card-header pb-0 px-3">
                    <h6 class="mb-0">{{ __('Crie um Novo Projeto') }}</h6>
                </div>
                <div class="card-body pt-4 p-3">
                    <form action="/project" method="POST" role="form text-left">
                        @csrf
                        @if($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="project-name" class="form-control-label">{{ __('Nome') }}</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="@error('description')border border-danger rounded-3 @enderror">
                                <textarea class="form-control" id="description" rows="3"
                                    placeholder="Por favor, descreva seu projeto" name="description"></textarea>
                            </div>
                        </div>
